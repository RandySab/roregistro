...
class JugadoreController extends Controller
{
    ...
    public function create()
    {
        ...
        $player_team = \Auth::user()->id;
        $player = Equipo::select('nombre',)->where('user_id','=', \Auth::user()->id )->get();
        
        return view('jugadore.create', compact('jugadore','equipos','users','player','player_team'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('jugadore.edit', compact('jugadore','equipos','users','player_team'));
    }
